...
\begin{frame}[c]{From predominant wh-ex situ to predominant wh-in situ}
    ...
    \begin{center}
        \includegraphics[width=10cm, height=6cm]{images/exsituperc.png}
    \end{center}
...
\begin{frame}[c]{From predominant wh-ex situ to predominant wh-in situ}
    ...
    \begin{center}
        \includegraphics[width=10cm, height=6cm]{images/exsituperc2.png}
    \end{center}
...
\begin{frame}[c]{From predominant wh-ex situ to predominant wh-in situ}
    ...
    \textbf{\textsc{general overview}}
    \begin{center}
        \includegraphics[width=10cm, height=6cm]{images/exsituperc3.png}
    \end{center}
